...
export default function UpdatePassword() {
    ...
    async function updatePassword(e) {
        ...
        try {
            const response = await fetch(`https://attendo-h4oc.onrender.com/${username}/profile/updatepassword`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className="flex justify-center items-center h-screen w-full bg-gray-900">
            <div className="h-[440px] w-[420px] rounded-lg py-4 px-5 bg-gray-700/70 shadow-2xl hover:scale-105 transition-all duration-300 max-sm:mx-4">
